 ...
 */
final class Version20220106101931 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE blog_post ADD CONSTRAINT FK_BA5AE01D63379586 FOREIGN KEY (comments_id) REFERENCES comment (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
